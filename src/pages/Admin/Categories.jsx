          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => {
                setShowCreate(true);
                setCreateError(null);
                setNewCategory({ name: "", description: "", maxPeople: 1 });
              }}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative w-full max-w-lg bg-white rounded shadow-lg p-6 z-10">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewCategory({
                        ...newCategory,
                        maxPeople: Number(e.target.value || 0),
                      })
                    }
              ...
              <div className="mt-6 flex justify-end gap-2">
                ...
                <button
                  onClick={async () => {
                    if (!newCategory.name || creating)
                      return setCreateError("Name is required");
                    setCreating(true);
                    setCreateError(null);
                    try {
                      await api.request(
                        "https://api.sweethotel.kodopo.tech/api/Categories",
                        {
                          method: "POST",
                          body: JSON.stringify({
                            ...
                            maxPeople:
                              Number(newCategory.maxPeople) || 0,
                          }),
                        }
                      );
                      await loadItems();
                ...
                <button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      await api.request(
                        `https://api.sweethotel.kodopo.tech/api/Categories/Delete/${id}`,
                        {
                          method: "POST",
                        }
                      );
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative w-full max-w-lg bg-white rounded shadow-lg p-6 z-10">
              ...
              <div className="mt-4 space-y-3">
                ...
                {editError && (
                  <div className="text-sm text-rose-600">{editError}</div>
                )}
              </div>
              <div className="mt-6 flex justify-end gap-2">
                <button
                ...
                <button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (!id) throw new Error("Missing category id");
                      await api.request(
                        `https://api.sweethotel.kodopo.tech/api/Categories/Update/${id}`,
                        {
                          method: "POST",
                          body: JSON.stringify({
                            ...
                            maxPeople:
                              Number(editCategory.maxPeople) || 0,
                          }),
                        }
                      );
                      await loadItems();
